                                    ...
                                    <CardContent className="relative space-y-5 p-8">
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            <Button
                                                ...
                                                asChild
                                            >
                                                <Link href={`/academy/contact?program=${program.id}`}>Discuss enrollment</Link>
                                            </Button>
                                            <Button
                                                size="sm"
                                                variant="outline"
                                                className="rounded-full border-primary/30 text-primary hover:border-primary hover:text-primary"
                                                asChild
                                            >
                                                <Link href="/academy/contact">Request brochure</Link>
                                            </Button>
                                        </div>
                                    </CardContent>
                                </Card>
